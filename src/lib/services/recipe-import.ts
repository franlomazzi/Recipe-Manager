// Client-side helper for /api/import-recipe. Mirrors the gemini-service.ts
// pattern: pull a fresh Firebase ID token from the active account, attach it
// as a bearer, let the server route burn the Gemini quota on our behalf.
